...
<template>
    <div class="flex-1 space-y-3 overflow-y-auto p-5">
        ...
        <button
            ...
            class="flex w-full items-center gap-3 rounded-2xl border border-gray-200 bg-white p-4 text-left shadow-sm transition-[transform,border-color,background-color] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] hover:border-orange-300 hover:bg-orange-50 active:scale-[0.99] disabled:opacity-50"
        >
        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm">
            <button
                ...
                class="flex w-full items-center gap-3 p-4 text-left transition-[transform,background-color] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] hover:bg-orange-50 active:scale-[0.99] disabled:opacity-50"
            >
                <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-red-600 text-white">
