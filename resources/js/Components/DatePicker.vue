...
<template>
    <div class="inline-flex items-center gap-1 rounded-xl bg-white px-1 py-1 ring-1 ring-gray-200">
        ...
        <button type="button" @click="goToday" class="flex items-center gap-2 whitespace-nowrap rounded-lg px-4 py-1.5 text-sm font-semibold text-gray-900 transition hover:bg-gray-50">
