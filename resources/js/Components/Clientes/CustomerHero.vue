...
const props = defineProps({
    ...
    /**
     * Activar/desactivar y eliminar cliente son del admin de sucursal.
     * En Caja el menú queda solo con "Editar datos".
     */
    canManageStatus: { type: Boolean, default: true },
});
...
<template>
    <section class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
        ...
        <div class="flex items-center gap-2 border-b border-gray-100 px-6 py-3 text-sm">
            <Link :href="route(`${routePrefix}.clientes.index`, tenantSlug)"
            ...
            <Link :href="route(`${routePrefix}.clientes.index`, tenantSlug)" class="text-gray-500 hover:text-gray-700">Clientes</Link>
                ...
                <div class="relative">
                    ...
                    <Transition enter-active-class="transition duration-100" leave-active-class="transition duration-75"
                        ...
                        <div v-if="showMenu"
                            ...
                            <button v-if="canManageStatus" type="button" @click="showMenu = false; $emit('toggle-status')"
                                class="flex w-full items-center gap-2 px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-50">
                            ...
                            <button v-if="canManageStatus" type="button" @click="showMenu = false; $emit('destroy')"
