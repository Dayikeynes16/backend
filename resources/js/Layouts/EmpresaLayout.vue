...
const baseNavLinks = [
    ...
    { label: 'Equipos', route: 'empresa.devices.index', match: 'empresa.devices', icon: 'equipos' },
    ...
    { label: 'Movimientos', route: 'empresa.movimientos.index', match: 'empresa.movimientos', icon: 'movimientos' },
            ...
            <nav class="flex-1 px-4 pt-8">
                ...
                <div class="space-y-1">
                    <Link v-for="link in navLinks" :key="link.route" :href="route(link.route, slug)"
                        ...
                        <!-- Equipos -->
                        <svg v-if="link.icon === 'equipos'" class="h-5 w-5 shrink-0 transition-colors" :class="isActive(link) ? 'text-white' : 'text-red-300 group-hover:text-white'" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" /></svg>
                        <!-- Usuarios -->
