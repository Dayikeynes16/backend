...
const performDelete = () => {
    ...
    deleteForm.delete(route('sucursal.gastos.destroy', [props.tenant.slug, detailExpense.value.id]), {
        preserveScroll: true,
        onSuccess: () => {
...
<template>
    ...
    <SucursalLayout>
        ...
        <div v-show="!canManageCategories || activeTab === 'gastos'" class="space-y-5">
            ...
            <!-- Table -->
            <div v-else class="overflow-x-auto rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
        ...
        <GastoFormModal
            ...
            attachment-download-route-name="sucursal.gastos.adjuntos.download"
