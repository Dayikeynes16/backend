...
const props = defineProps({ data: Object, range: Object, compare: Boolean, tenant: Object, inactive_days: Number });
const filters = useMetricsFilters('sucursal.metricas.clientes');
</script>
