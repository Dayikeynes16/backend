            ...
            <div class="rounded-xl bg-white shadow-sm ring-1 ring-gray-100">
                ...
                <div class="border-t border-gray-100 px-5 py-3 flex items-center justify-between">
                    <div class="flex flex-wrap items-center gap-4 text-xs text-gray-400">
                        ...
                        <span v-if="(totals.cash_expenses ?? 0) > 0">Gastos: <span class="font-semibold text-red-500">-${{ (totals.cash_expenses ?? 0).toFixed(2) }}</span></span>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs"
                                            ...
                                            <template v-else-if="totalStatus === 'ok'">El turno cuadra perfecto</template>
