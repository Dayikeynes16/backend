...
const openShift = () => {
    router.post(route('caja.shift.store', props.tenant.slug));
};
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Abrir Turno</h2>
        </template>
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    <div class="p-8 text-center">
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                            Abre tu turno para empezar a cobrar ventas.
                        </p>
                        <PrimaryButton @click="openShift" class="mt-6">
                            Abrir Turno
                        </PrimaryButton>
                    </div>
                </div>
