...
// El Historial de caja es donde vive el detalle de la venta. Buscar por folio
// ignora la fecha allá, así que el salto funciona aunque la venta sea de otro día
// —el caso típico del fiado cobrado hoy—.
const historyUrl = (folio) => route('caja.historial', { tenant: props.tenant.slug, search: folio });
