...
/**
 * Endpoints JSON de solo lectura de la ficha de un cliente (stats, historial,
 * top productos, detalle de venta y pagos). Los consumen tanto admin-sucursal
 * como cajero: son idénticos para ambos porque solo leen y ya filtran por la
 * sucursal del usuario autenticado.
 *
 * Requiere `AuthorizesCustomerAccess` en el controller que lo usa.
 */
trait HandlesCustomerStats
{
    /**
