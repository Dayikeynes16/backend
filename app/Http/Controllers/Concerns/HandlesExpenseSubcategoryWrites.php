...
/**
 * Escritura de subcategorías de gasto (tenant-wide). Compartido por empresa y
 * sucursal; el admin-sucursal se gatea con `branch_admin_expense_categories_enabled`.
 * El borrado (destroy) NO vive aquí: queda reservado a empresa/superadmin.
 */
trait HandlesExpenseSubcategoryWrites
{
