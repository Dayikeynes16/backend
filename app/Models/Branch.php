...
#[Fillable([
    ...
    'cashier_expenses_enabled', 'cashier_purchases_enabled', 'cashier_customers_enabled',
    'cashier_scale_sales_enabled',
...
class Branch extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'cashier_customers_enabled' => 'boolean',
            'cashier_scale_sales_enabled' => 'boolean',
            'branch_admin_providers_enabled' => 'boolean',
            'branch_admin_movements_enabled' => 'boolean',
