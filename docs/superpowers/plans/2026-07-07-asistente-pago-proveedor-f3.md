...
- [ ] Tests → FAIL → implementar → PASS → commit.
...
- [ ] Tests → FAIL → implementar → PASS → pint + commit.
...
- [ ] Suites: Ai + Compras/ProviderPaymentControllerTest + Services → PASS; suite completa → PASS; commit.
