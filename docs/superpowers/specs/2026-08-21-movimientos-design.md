...
`item_added`, `item_updated`, `item_removed`, `payment_updated`, `payment_deleted`, `reopened`, `customer_assigned`, `customer_removed`. Los existentes (`cancelled`, `payment_added`, `payment_cancelled`) se reutilizan.
