...
| Agenda | ✅ Completo |
| Asistente IA conversacional | ✅ F0–F4 · ✅ mini-app móvil `/{tenant}/asistente` (spec 2026-07-06, F0+F1; pendiente F2 cobro FIFO, F3 pago proveedores, F4 modo simple) · pendiente F5 (config asistida) y F6 parcial (purga >90 días, suite adversarial, observabilidad) · TTS off en UI |
