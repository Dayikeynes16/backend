...
- [Layouts en tablet y teléfono](frontend/layouts-responsivo.md) — encabezado global flexible, filtros fuera del header, lista+detalle, rejillas y tablas en pantallas medianas y chicas
